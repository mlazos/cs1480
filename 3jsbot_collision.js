...
function robot_collision_forward_kinematics (q) { 
    ...
    var mstack = matrix_multiply(generate_translation_matrix(q[0],q[1],q[2]),matrix_multiply(matrix_multiply(generate_z_rotation(q[5]),generate_y_rotation(q[4])),generate_x_rotation(q[3])));
